...
const I18N = {
  fr: {
    ...
    continueWhatsApp: "Continuer avec WhatsApp / téléphone",
    phoneLabel: "Numéro de téléphone",
    phonePlaceholder: "+237 6XX XX XX XX",
    sendCodeBtn: "Envoyer le code",
    otpHint: "Saisis le code reçu (SMS / WhatsApp)",
    verifyCodeBtn: "Valider le code",
    resendCodeBtn: "Renvoyer le code",
    phoneErrorFormat: "Numéro invalide (ex : +237650123456)",
    phoneErrorOtp: "Code incorrect ou expiré — réessaie",
    phoneWelcome: "Bienvenue ! Ton numéro est vérifié ✅",
 ...
 newMsgs: "Nouveaux messages",
    ...
    jobsNearby: "Jobs proches", sortLabel: "Trier :", sortNearest: "Le plus proche", sortRating: "Mieux notés", sortPrice: "Moins cher", sortNewest: "Plus récent", emptyTitle: "Aucun job trouve", emptySub: "Publiez le premier job dans cette zone",
  ...
  en: {
    ...
    continueWhatsApp: "Continue with WhatsApp / phone",
    phoneLabel: "Phone number",
    phonePlaceholder: "+237 6XX XX XX XX",
    sendCodeBtn: "Send code",
    otpHint: "Enter the code you received (SMS / WhatsApp)",
    verifyCodeBtn: "Verify code",
    resendCodeBtn: "Resend code",
    phoneErrorFormat: "Invalid number (e.g. +237650123456)",
    phoneErrorOtp: "Wrong or expired code — try again",
    phoneWelcome: "Welcome! Your number is verified ✅",
 ...
 newMsgs: "New messages",
    ...
    jobsNearby: "Nearby jobs", sortLabel: "Sort by", sortNearest: "Nearest", sortRating: "Top rated", sortPrice: "Cheapest", sortNewest: "Newest", emptyTitle: "No jobs found", emptySub: "Post the first job in this area",
  ...
  it: {
    ...
    continueWhatsApp: "Continua con WhatsApp / telefono",
    phoneLabel: "Numero di telefono",
    phonePlaceholder: "+237 6XX XX XX XX",
    sendCodeBtn: "Invia il codice",
    otpHint: "Inserisci il codice ricevuto (SMS / WhatsApp)",
    verifyCodeBtn: "Verifica il codice",
    resendCodeBtn: "Rinvia il codice",
    phoneErrorFormat: "Numero non valido (es. +237650123456)",
    phoneErrorOtp: "Codice errato o scaduto — riprova",
    phoneWelcome: "Benvenuto! Il tuo numero è verificato ✅",
 ...
 newMsgs: "Nuovi messaggi",
    ...
    jobsNearby: "Lavori vicini", sortLabel: "Ordina:", sortNearest: "Più vicino", sortRating: "Migliori", sortPrice: "Prezzo più basso", sortNewest: "Più recente", emptyTitle: "Nessun lavoro trovato", emptySub: "Pubblica il primo lavoro in questa zona",
  ...
  de: {
    ...
    continueWhatsApp: "Mit WhatsApp / Telefon fortfahren",
    phoneLabel: "Telefonnummer",
    phonePlaceholder: "+237 6XX XX XX XX",
    sendCodeBtn: "Code senden",
    otpHint: "Eingehenden Code eingeben (SMS / WhatsApp)",
    verifyCodeBtn: "Code bestätigen",
    resendCodeBtn: "Code erneut senden",
    phoneErrorFormat: "Ungültige Nummer (z. B. +237650123456)",
    phoneErrorOtp: "Falscher oder abgelaufener Code — erneut versuchen",
    phoneWelcome: "Willkommen! Deine Nummer ist verifiziert ✅",
 ...
 newMsgs: "Neue Nachrichten",
    ...
    jobsNearby: "Jobs in der Nähe", sortLabel: "Sortieren:", sortNearest: "Nächste", sortRating: "Beste bewertet", sortPrice: "Günstigste", sortNewest: "Neueste", emptyTitle: "Keine Jobs gefunden", emptySub: "Veröffentlichen Sie den ersten Job in dieser Gegend",
  ...
  zh: {
    ...
    qrRecommend: "⭐ 我推荐你",
    specialtiesLabel: "专长",
    continueWhatsApp: "通过 WhatsApp / 手机继续",
    phoneLabel: "电话号码",
    phonePlaceholder: "+237 6XX XX XX XX",
    sendCodeBtn: "发送验证码",
    otpHint: "输入你收到的验证码（短信 / WhatsApp）",
    verifyCodeBtn: "验证代码",
    resendCodeBtn: "重新发送",
    phoneErrorFormat: "号码无效（例：+237650123456）",
    phoneErrorOtp: "代码错误或已过期 — 请重试",
    phoneWelcome: "欢迎！你的号码已验证 ✅",
 ...
 newMsgs: "新消息",
    ...
    jobsNearby: "附近的工作", sortLabel: "排序", sortNearest: "最近", sortRating: "评分最高", sortPrice: "价格最低", sortNewest: "最新", emptyTitle: "未找到工作", emptySub: "在该区域发布第一份工作",
...
// ============================================================
// CONNEXION WHATSAPP / TÉLÉPHONE (Firebase Phone Auth + reCAPTCHA
// invisible) — le « easy login via WhatsApp » de Wassa, mais sans
// intermédiaire : le code part en SMS vers le numéro saisi.
// Le bouton ne s'affiche QUE si une clé reCAPTCHA est configurée
// ci-dessous, via l'un des DEUX chemins (le plus simple suffit) :
//  1. APP CHECK (reCAPTCHA v3) — recommandé : protège aussi les services
//     Firebase contre les bots, et l'auth téléphone se fait sans prompt.
//     (Firebase Console → App Check → enregistrer l'app web → reCAPTCHA →
//     la clé du wizard se colle dans RECAPTCHA_V3_CFG.siteKey ci-dessous)
//  2. reCAPTCHA v2 « invisible » seule (Google Cloud Console → Identifiants
//     → Clé reCAPTCHA → v2 invisible, domaine autorisé =
//     ghislaintankat-cyber.github.io) → RECAPTCHA_PHONE_SITE_KEY.
// Les deux clés vides = bouton masqué, zéro impact sur le reste de l'app.
// ============================================================
const RECAPTCHA_PHONE_CFG = { siteKey: '' }; // ← chemin 2 : '6Lc...'
// Chemin 1 (App Check) : clé reCAPTCHA Enterprise (console Google Cloud →
// Fraud Defense → reCAPTCHA Enterprise → clés). `mode` force le provider :
//   'enterprise' → ReCaptchaEnterpriseProvider (clés de la console Fraud
//                  Defense — ATTENTION : elles peuvent commencer par
//                  `6Lc…` comme les anciennes clés, le préfixe ne suffit pas)
//   'v3'         → RecaptchaV3TokenProvider (anciennes clés v3)
//   'auto'       → `sx-…` = enterprise, sinon v3 (règle historique)
const RECAPTCHA_V3_CFG = { siteKey: '6LcLLaoTAAAAAPutUiCeDrX4Mzy1hUmsDhUvH4mZ', mode: 'enterprise' };
try { window.__recaptchaV3Cfg = RECAPTCHA_V3_CFG; } catch (e) {} // tests jsdom
try { window.__recaptchaPhoneCfg = RECAPTCHA_PHONE_CFG; } catch (e) {} // tests jsdom
let phoneRecaptchaVerifier = null;
let appCheckProvider = null;
let appCheckBroken = false; // clé reCAPTCHA en échec (billing, test, domaine…)
let phoneConfirmationResult = null;

function phoneAuthEnabled() { return !!(RECAPTCHA_PHONE_CFG.siteKey || (RECAPTCHA_V3_CFG && RECAPTCHA_V3_CFG.siteKey)); }

// App Check : si la clé est configurée, le provider sert à la fois de
// vérificateur d'auth téléphone (interface ApplicationVerifier) et de
// protection anti-bot des services Firebase. Silencieux si absent.
// Google a obsolétisé le reCAPTCHA standard (v2/v3) pour App Check au profit
// de reCAPTCHA **Enterprise** : les deux sont donc gérés par AUTO-DÉTECTION
// sur le préfixe de la clé —
//   • clé « sx-… »  → reCAPTCHA Enterprise (console App Check actuelle)
//   • clé « 6Lc… »  → reCAPTCHA v3 standard (si un jour encore disponible)
function initAppCheckIfConfigured() {
  try {
    const cfg = RECAPTCHA_V3_CFG;
    const key = cfg && cfg.siteKey;
    if (!key) return;
    if (!window.firebase || typeof firebase.appCheck !== 'function') return;
    // Choix du provider : mode explicite d'abord (les clés Enterprise de la
    // nouvelle console commencent par `6Lc…` comme les anciennes — le
    // préfixe seul ne permet PAS de distinguer les deux), sinon auto.
    let useEnterprise;
    const mode = cfg.mode;
    if (mode === 'enterprise') useEnterprise = true;
    else if (mode === 'v3') useEnterprise = false;
    else useEnterprise = String(key).indexOf('sx-') === 0;
    // API compat v9.23 : firebase.appCheck.ReCaptchaEnterpriseProvider /
    // firebase.appCheck.ReCaptchaV3Provider (certaines versions nomment la
    // 2e classe RecaptchaV3TokenProvider — on essaie les deux).
    const Prov = useEnterprise
        ? firebase.appCheck.ReCaptchaEnterpriseProvider
        : (firebase.appCheck.ReCaptchaV3Provider || firebase.appCheck.RecaptchaV3TokenProvider);
    if (!Prov) return;
    const provider = new Prov(key);
    const ac = firebase.appCheck();
    // L'initialisation compat s'appelle activate(provider, autoRefresh) —
    // l'instance ainsi activée implémente ApplicationVerifier (getToken) et
    // sert directement de vérificateur à signInWithPhoneNumber.
    if (ac && typeof ac.activate === 'function') {
      ac.activate(provider, true);
      appCheckProvider = ac;
      // Résilience : si la clé reCAPTCHA est cassée (billing non activé, clé
      // « test uniquement », domaine non autorisé…), le token App Check
      // renvoie appCheck/recaptcha-error — et la connexion RTDB Firebase est
      // refusée (le token est attaché à la connexion). On ne peut PAS
      // désactiver App Check côté client : la vraie correction est côté
      // Google Cloud (billing / clé). Ce qu'on fait ici : détecter l'échec
      // UNE FOIS, le signaler clairement à l'admin, et ne plus offrir le
      // login téléphone via un App Check cassé (repli clé v2 si présente).
      if (typeof ac.onTokenChanged === 'function') {
        ac.onTokenChanged(
          () => {},
          (err) => {
            if (appCheckBroken) return;
            appCheckBroken = true;
            appCheckProvider = null;
            console.error('App Check : la clé reCAPTCHA est en échec (' + ((err && err.code) || 'erreur inconnue') + ') — la base Firebase peut refuser les connexions. CORRECTION (côté Google Cloud Console, projet jobmarketfuture) : (1) ACTIVER LA FACTURATION (reCAPTCHA Enterprise l’exige — quota gratuit mais carte requise), (2) vérifier que la clé « jobmarket-web » est ACTIVE et PAS « test uniquement », (3) vérifier que le domaine ghislaintankat-cyber.github.io est autorisé, puis recharger. Si impossible : vider RECAPTCHA_V3_CFG.siteKey dans app.js et redéployer (l’app repart sans App Check).', err);
            try { logClientError('AppCheck recaptcha-error: ' + ((err && err.code) || 'erreur'), 'app-check-token'); } catch (e) {}
          }
        );
      }
    }
  } catch (e) { console.warn('App Check init:', e); appCheckProvider = null; }
}

// Vérificateur de l'auth téléphone : App Check en priorité (sans prompt),
// repli sur le conteneur reCAPTCHA v2 invisible.
async function getPhoneVerifier() {
  if (appCheckProvider && !appCheckBroken) return appCheckProvider;
  if (RECAPTCHA_PHONE_CFG.siteKey) return ensurePhoneRecaptcha();
  return null;
}
try { window.__phoneAuthTest = { resetAppCheck: () => { appCheckProvider = null; }, getProvider: () => appCheckProvider, resetRecaptcha: () => { phoneRecaptchaVerifier = null; } }; } catch (e) {}
initAppCheckIfConfigured();

function togglePhoneAuthBox() {
  const box = document.getElementById('phoneAuthBox');
  if (!box) return;
...
// reCAPTCHA invisible, instancié une seule fois
async function ensurePhoneRecaptcha() {
  if (phoneRecaptchaVerifier) return phoneRecaptchaVerifier;
  const container = document.getElementById('phoneRecaptchaContainer');
  phoneRecaptchaVerifier = new firebase.auth.RecaptchaVerifier(container, { size: 'invisible' }, auth);
  try { await phoneRecaptchaVerifier.render(); } catch (e) { /* certains environnements ne rendent rien */ }
...
async function sendPhoneOtp() {
  const inp = document.getElementById('phoneNumberInput');
  const num = normalizePhone(inp && inp.value);
  if (!/^\+?\d{9,15}$/.test(num)) { showToast(t('phoneErrorFormat'), 'error'); return; }
  const e164 = num.startsWith('+') ? num : '+' + num;
  try {
    const verifier = await getPhoneVerifier();
    if (!verifier) { showToast(t('phoneErrorOtp'), 'error'); return; }
    phoneConfirmationResult = await auth.signInWithPhoneNumber(e164, verifier);
    const s1 = document.getElementById('phoneStep1');
    const s2 = document.getElementById('phoneStep2');
    if (s1) s1.style.display = 'none';
    if (s2) s2.style.display = 'block';
    const otp = document.getElementById('phoneOtpInput');
    if (otp) { otp.value = ''; otp.focus(); }
  } catch (err) {
    console.warn('sendPhoneOtp error', err);
    showToast(t('phoneErrorOtp'), 'error');
  }
}
...
async function resendPhoneOtp() {
  ...
  try {
    ...
    console.warn('resendPhoneOtp error', err);
    showToast(t('phoneErrorOtp'), 'error');
  }
}
...
async function verifyPhoneOtp() {
  const otp = document.getElementById('phoneOtpInput');
  const code = String(otp && otp.value || '').trim();
  if (!phoneConfirmationResult) return;
  if (!/^\d{6}$/.test(code)) { showToast(t('phoneErrorOtp'), 'error'); return; }
  try {
    const cred = await phoneConfirmationResult.confirm(code);
    onPhoneAuthSuccess(cred);
  } catch (err) {
    console.warn('verifyPhoneOtp error', err);
    showToast(t('phoneErrorOtp'), 'error');
  }
}

function onPhoneAuthSuccess(cred) {
  const user = cred && cred.user;
  if (!user) return;
  // Le numéro est VÉRIFIÉ (code SMS reçu) → badge 📱 automatique +
  // numéro conservé dans le profil (contact + badge de confiance).
  ...
  showToast(t('phoneWelcome'), 'success');
  const box = document.getElementById('phoneAuthBox');
  if (box) box.style.display = 'none';
  phoneConfirmationResult = null;
  try { closeOverlay('accountPage'); } catch (e) {}
  // onAuthStateChanged fait le reste (UI, listeners, badge de boîte…)
}
...
// 4 critères : le plus proche (défaut) / mieux notés / moins cher / plus
// récent. Le choix est persisté (localStorage). Le tri s'applique dans
// updateJobsList (le seul point d'affichage) → les onglets « Tous » et
// « Sauvegardés » sont tous les deux triés, sans toucher aux marqueurs
// de la carte (l'ordre n'a pas de sens pour eux).
let currentJobSort = 'dist';
try { const _jobSortSaved = localStorage.getItem('jobSort'); if (['dist', 'rating', 'price', 'newest'].includes(_jobSortSaved)) currentJobSort = _jobSortSaved; } catch (e) {}
...
function setJobSort(mode) {
  if (!['dist', 'rating', 'price', 'newest'].includes(mode)) mode = 'dist';
  currentJobSort = mode;
...
function renderPublicPortfolio(profile) {
    ...
    if (gal) {
        ...
        <div style="width:90px;height:90px;border-radius:10px;overflow:hidden;border:1px solid var(--border,#333);">
...
// Connexion WhatsApp/téléphone : le bouton n'apparaît que si une clé
// reCAPTCHA est configurée (RECAPTCHA_PHONE_SITE_KEY) — sinon masqué.
try {
  if (phoneAuthEnabled()) {
